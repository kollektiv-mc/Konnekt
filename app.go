...
// AcceptEula writes the server's eula.txt through ConfigEditorService, which
// owns the atomic write and the working-directory check (#259); this method
// only narrates the outcome.
