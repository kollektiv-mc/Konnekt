...
// this one opened a white list over the dark modal (#369), the same defect
// #160 fixed in the scheduler panel. Eleven entries is past what Segmented can
// show, and the combobox's typeahead is worth having over that many.
//
// The empty value is load-bearing: it is what the detection path reads, so
// "Detect automatically" writes an empty loader rather than a sentinel.
