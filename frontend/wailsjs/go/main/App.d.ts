...
export function AbortInstall():Promise<void>;
...
export function GetServerSummary(arg1:string):Promise<models.ServerSummary>;
...
export function InstallServer(arg1:string,arg2:string):Promise<void>;
...
export function LogClientError(arg1:string,arg2:string,arg3:string):Promise<void>;
