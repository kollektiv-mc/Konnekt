...
export function AbortInstall() {
  return window['go']['main']['App']['AbortInstall']();
}
...
export function GetServerSummary(arg1) {
  return window['go']['main']['App']['GetServerSummary'](arg1);
}
...
export function InspectServerFile(arg1) {
  return window['go']['main']['App']['InspectServerFile'](arg1);
}

export function InstallServer(arg1, arg2) {
  return window['go']['main']['App']['InstallServer'](arg1, arg2);
}
